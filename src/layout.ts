...
export const DISTRICTS: District[] = [
  ...
  { kind: "park", landmark: "City Park, south lawn", indoor: false, box: { x0: c.park.x0, x1: c.park.x1, z0: -36, z1: c.park.z1 }, pose: { x: -16, z: -36, yaw: Math.PI / 2 },
  ...
  { kind: "park", landmark: "City Park, north grove", indoor: false, box: { x0: c.park.x0, x1: c.park.x1, z0: c.park.z0, z1: -36 }, pose: { x: -16, z: -36, yaw: Math.PI / 2 },
  ...
  { kind: "stalls", landmark: "Market Square", indoor: false, box: { x0: c.market.x0, x1: c.market.x1, z0: c.market.z0, z1: c.market.z1 }, pose: { x: 16, z: -36, yaw: -Math.PI / 2 },

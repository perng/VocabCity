...
- Each of the fifteen landmark groups has six works, spanning impressionist oils, botanical watercolors, contemporary gouache and collage, or soft pastel and charcoal; each root family is its own series with a medium drawn from the museum's twenty-three. Choose **欣賞畫作 / View artwork** in a word's detail view to inspect its large painting, localized title, and medium.
